...
public:
    Lesson2(Ui::MainWindow *ui, Controller &controller);
    void initLesson();
    void stepLesson();
    void completeLesson();
};
...
public:
    Lesson3(Ui::MainWindow *ui, Controller &controller);
    void initLesson();
    void stepLesson();
    void completeLesson();
};
...
public:
    Lesson4(Ui::MainWindow *ui, Controller &controller);
    void initLesson();
    void stepLesson();
    void completeLesson();
};
...
public:
    Lesson5(Ui::MainWindow *ui, Controller &controller);
    void initLesson();
    void stepLesson();
    void completeLesson();
};
...
public:
    Lesson6(Ui::MainWindow *ui, Controller &controller);
    void initLesson();
    void stepLesson();
    void completeLesson();
};
